...
<body class="bg-white">
    <div class="bg-[#b7d401] px-4 py-3 text-white flex justify-between">
        <p class="text-center text-sm font-medium">
            ...
            <a href="https://www.google.com/maps/place/MA+Anshaarul+Huda/@-7.5871065,107.8113068,17z/data=!3m1!4b1!4m6!3m5!1s0x2e66119713a4f6fb:0xb19d9d5b6ca57c4d!8m2!3d-7.5871065!4d107.8113068!16s%2Fg%2F11sq2tbf42?entry=ttu&g_ep=EgoyMDI0MTExOS4yIKXMDSoASAFQAw%3D%3D"
                target="_blank" class="inline-block">Komplek Yayasan Anshaarul Huda, Cihaurkuning, Cisompet, Kabupaten
                Garut, Jawa Barat - 44174</a>
        </p>
        <p class="text-center text-sm font-medium">
    ...
    <footer class="bg-gray-100">
        <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
                Yayasan Anshaarul Huda hadir untuk melayani masyarakat melalui program sosial, pendidikan, dan
            ...
            <ul class="mt-12 flex justify-center gap-6 md:gap-8">
                <li>
                    <a href="https://instagram.com/anshaarul.huda" rel="noreferrer" target="_blank"
                ...
                <li>
                    <a href="https://www.tiktok.com/@anshaarul.huda?_r=1&_d=egdcf2ee8g3ekb&sec_uid=MS4wLjABAAAADmWPg38HtAd7s3FDXYX25Jrss8eZM1O-FUjor9ZA2mvNXa9LrAaL0hvsd_3Kqsds&share_author_id=7085339881828156442&sharer_language=id&source=h5_t&u_code=deac88264klgh8&ug_btm=b6880,b5836&sec_user_id=MS4wLjABAAAA7E1-5naExmgtLjyC0ue_8MBz44b1zs-GVENypZrvkzGQjqDm6NlHt_pP_qgMAah3&utm_source=copy&social_share_type=5&utm_campaign=client_share&utm_medium=ios&tt_from=copy&user_id=6869317706374710273&enable_checksum=1&share_link_id=3CEE2EAD-3D24-4A15-9902-4DC9475A133B&share_app_id=1180"
                        rel="noreferrer" target="_blank" class="text-gray-700 transition hover:text-gray-700/75">
                        <span class="sr-only">Tiktok</span>
                        <img class="w-5 h-5" src="/assets/logo-tiktok.svg" alt="Logo Tiktok" />
                    </a>
                </li>

                <li>
                    <a href="https://www.youtube.com/@OSISMPKAnshaarulHuda" rel="noreferrer" target="_blank"
                        class="text-gray-700 transition hover:text-gray-700/75">
                        <span class="sr-only">Tiktok</span>
                        <img class="w-5 h-5" src="/assets/logo-youtube.svg" alt="Logo Youtube" />
                    </a>
                </li>
            </ul>
        </div>
